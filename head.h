...
void pogr1(float(*do_param)(float* Uvx, float* t, int n),void(*arr_create_t)(float* t, float tn, float tk, int n),void(*arr_create_Uvx2)(float* Uvx, int* Ui, float* t, int n, int kd), void(*arr_create_Uvix)(float* Uvix, float* Uvx, int n), float *t, float* Uvx, float* Uvix, int* Ui, int n, float dt);
